...
new function () {
    ...
    function EnsureTransitionInstance(options) {

        var _SlideshowTransition = {
            $Interval: $JssorUtils$.$IsBrowserIe9Earlier() || $JssorUtils$.$IsBrowserOpera() ? 40 : 16,  //Delay to play next frame
        ...
        if (_SlideshowTransition.$Brother) {
            _SlideshowTransition.$Brother = EnsureTransitionInstance(_SlideshowTransition.$Brother);
    ...
    $JssorSlideshowRunner$ = window.$JssorSlideshowRunner$ = function (slideContainer, slideContainerWidth, slideContainerHeight, slideshowOptions) {
        ...
        _SelfSlideshowRunner.$Initialize = function (slideIndex, prevIndex, slideItem, prevItem, slideshowTransition) {
            ...
            slideshowTransition = EnsureTransitionInstance(slideshowTransition);
            ...
            var slideTransitionBelow = slideshowTransition.$Brother || EnsureTransitionInstance({});
    ...
    function JssorSlider(elmt, options) {
        ...
        function CarouselPlayer(carousel, slideshow) {
            ...
            _SelfCarouselPlayer.$PlayCarousel = function (fromPosition, toPosition, duration, callback) {
                ...
                //if (_Options.$HwaMode && $JssorUtils$.$IsBrowserBadTransform() && !_HandleTouchEventOnly) {
                //    $JssorUtils$.$Delay($JssorUtils$.$CreateCallback(_SelfCarouselPlayer, _SelfCarouselPlayer.$PlayToPosition, duration, callback), 60);
                //    $JssorUtils$.$EnableHWA(_SlideboardElmt, _HandleTouchEventOnly);
                //}
                //else
            ...
            _SelfCarouselPlayer.$StandBy = function (standByPosition) {
                //if (_Options.$HwaMode && $JssorUtils$.$IsBrowserSafeHWA() && _HandleTouchEventOnly) {
                //    $JssorUtils$.$EnableHWA(_SlideboardElmt, _HandleTouchEventOnly);
                //}
                _StandBy = true;
        ...
        function SlideItem(slideElmt, slideIndex) {
            ...
            function ParkEventHandler(currentIndex, previousIndex) {
                if (currentIndex == slideIndex) {
                    ...
                    //if (_Options.$HwaMode && $JssorUtils$.$IsBrowserBadTransform() && !_HandleTouchEventOnly) {
                    //    $JssorUtils$.$DisableHWA(_SlideboardElmt);
                    //}
                }
                else {
            ...
            function RefreshContent(elmt, fresh, level) {
                ...
                if (!_ContentRefreshed) {
                    ...
                    //else if ($JssorUtils$.$IsBrowserChrome() && slideElmt == elmt) {
                    //    elmt.style["-webkit-transform"] = "translateZ(0px)";
                    //    elmt.style["-webkit-transition-duration"] = "0s";
                    //}
                    else {
        ...
        //$JssorSlider$ Constructor
        {
            ...
            //SlideBoard Constructor
            {
                ...
                if (_SlideshowEnabled)
                    _SlideshowRunner = new _SlideshowRunnerClass(_SlideContainer, _SlideWidth, _SlideHeight, _SlideshowOptions);
